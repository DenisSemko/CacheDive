...
{ 
    ...
    public async Task<ActionResult<Basket>> Post([FromBody] Basket entity)
    {
    ...
    {
        await _unitOfWork.Baskets.UpdateAsync(entity.Id, entity);
        return NoContent();
    }
    ...
    {
        await _unitOfWork.Baskets.DeleteAsync(id);
        return NoContent();
    }
